# -*- coding: utf-8 -*-
"""Pure text/structure builders for quiz messages. No nextcord here — nammaoe2bot/features/quiz/
embeds.py wraps these into Embed/View. Keeping the formatting pure makes it
unit-testable (the nammaoe2bot/features/lobby/view.py pattern)."""
...
# the clock gate in nammaoe2bot/features/quiz/interactions.py still needs it.
