...
backed by the identity resolver (nammaoe2bot/features/identity/resolver.py) rather than the dedicated
...
deleted in identity v2 (spec section 4) and replaced by nammaoe2bot/features/identity/solver.py.
...
and per-player civ attribution in nammaoe2bot/features/lobby/completed.py, both best-effort. The
