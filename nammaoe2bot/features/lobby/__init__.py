...
production and its declaration is deleted, because nammaoe2bot/features/identity/resolver.py's
...
recreate it on the next boot). nammaoe2bot/features/lobby/profile_map.py reads the resolver.
...
from .jobs import jobs  # noqa: E402,F401  (LobbyJobs singleton — nammaoe2bot.features.lobby.jobs.think)
