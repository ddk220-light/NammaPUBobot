...
nammaoe2bot/features/storylines/insights.py teases — "does the curse break tonight?" — and until now
...
restart hands a restored match a brand-new id. nammaoe2bot/features/storylines/insights.py pins all
...
from nammaoe2bot.features.storylines import insights as ti
