...
nammaoe2bot/features/postgame/card.py (Match Cards / Tale of the Tape embeds), and nammaoe2bot/web/server.py
...
# column lists (nammaoe2bot/web/server.py, nammaoe2bot/features/postgame/card.py) must include all of these —
