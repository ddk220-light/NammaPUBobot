...
[Castle click, 3rd additional TC). Foot archers queue as "Archer"; Crossbowman/Arbalester are
...
CLASSIFICATION = make(
    ...
    trigger_spec="a player who made more than 20 foot Archer-line units (crossbows; the mounted Camel Archer excluded) between clicking Castle Age and building a 3rd additional Town Center",
