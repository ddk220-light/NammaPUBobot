"""Ram push (Early-Castle family): >3 Rams in the early-Castle window [Castle click, 3rd additional
...
CLASSIFICATION = make(
    ...
    sig_tech="Capped Ram",
    trigger_spec="a player who made more than 3 Rams (Battering/Capped/Siege Ram) between clicking Castle Age and building a 3rd additional Town Center",
