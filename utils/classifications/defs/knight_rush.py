...
[Castle click, 2nd additional TC). Knights queue as "Knight"; Cavalier/Paladin are upgrades, and
...
CLASSIFICATION = make(
    ...
    sig_tech="Cavalier",
    trigger_spec="a player who made more than 20 Knights (Teutonic Knight excluded) between clicking Castle Age and building a 2nd additional Town Center",
