...
[Castle click, 3rd additional TC). Cavalry Archers queue as "Cavalry Archer"; Heavy Cavalry Archer
...
CLASSIFICATION = make(
    ...
    sig_tech="Thumb Ring",
    trigger_spec="a player who made more than 20 Cavalry Archers between clicking Castle Age and building a 3rd additional Town Center",
