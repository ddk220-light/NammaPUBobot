	...
	cfg_factory = CfgFactory(
		...
		variables=[
			...
			Variables.IntVar(
				...
				section="Rating",
				description="Weekly rating decay toward the nearest rank. Applies only to players inactive for 1+ month; a single game cancels it.",
				default=10,
			...
			Variables.IntVar(
				...
				section="Rating",
				description="Weekly deviation (uncertainty) growth toward the initial value. Applies only to players inactive for 1+ month; a single game cancels it, so active players settle toward the minimum.",
				default=15,
