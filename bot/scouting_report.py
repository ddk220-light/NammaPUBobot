...
# bot/post_game.MEDAL_GLYPHS already stamps on the match card for the same two
# awards -- a player who sees a crossed sword on the card should see the same
# mark here. Copied rather than imported: bot/post_game.py reaches Discord and
...
def gaps(rollups_by_user, window_user_ids):
	...
	point: identity v2 SS3 has always required this list, and it was left
	...
	for block, _key_field, feature, _template in _SPLIT_BLOCKS:
